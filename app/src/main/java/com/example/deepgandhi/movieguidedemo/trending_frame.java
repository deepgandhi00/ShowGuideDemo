...
public class trending_frame extends Fragment {
    ...
    class MoviesList extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try{
                URL url=new URL(getResources().getString(R.string.tv_trending_url)+getResources().getString(R.string.api_key));
                Log.i("urltrending",url.toString());
